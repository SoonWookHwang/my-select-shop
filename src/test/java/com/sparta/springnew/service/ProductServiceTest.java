package com.sparta.springnew.service;

import com.sparta.springnew.dto.ProductMypriceRequestDto;
...
import static com.sparta.springnew.mockobject.MockProductService.MIN_MY_PRICE;
...
// given
        ...
        when(productRepository.findById(productId))    // 사용케이스 정의
